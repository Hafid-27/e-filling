...
<div class="panel panel-default">
	...
	<form class="form-horizontal" method="POST" id="barang_form" action="<?php if ($data != null) echo base_url('admin_system/barang_update');
																			else echo base_url('admin_system/barang_add'); ?>">
		...
		<div class="panel-body">
			...
			<div class="form-group">
				...
				<div class="col-md-2 col-xs-12">
					<input type="text" class="form-control" value="<?php if ($data != null) echo $data->id_barang;
