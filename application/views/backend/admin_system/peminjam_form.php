...
<div class="panel panel-default">
	...
	<form class="form-horizontal" method="POST" id="peminjam_form" action="<?php if ($data != null) echo base_url('admin_system/peminjam_update');
																			else echo base_url('admin_system/peminjam_add'); ?>">
		...
		<div class="panel-body">
			...
			<div class="form-group">
				...
				<div class="col-md-2 col-xs-12">
					<input type="text" class="form-control" value="<?php if ($data != null) echo $data->id_peminjam;
			...
			<div class="form-group">
				...
				<div class="col-md-2 col-xs-12">
					<input type="text" name="password" class="form-control" value="<?php if ($data != null) echo $data->password; ?>">
				</div>
			</div>
			<div class="form-group">
